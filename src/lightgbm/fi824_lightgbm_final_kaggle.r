...
cat("\nLag y delta delta lag de 6 meses\n")
...
# FI: Ranking con 0 fijo de cada cliente de cada mes en todas las features con montos  - V2
cat("\nRanking de features con montos\n")
