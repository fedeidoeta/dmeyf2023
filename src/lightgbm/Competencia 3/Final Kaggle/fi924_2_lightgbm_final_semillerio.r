...
PARAM$finalmodel$optim$num_iterations <- 874
PARAM$finalmodel$optim$learning_rate <- 0.0895
PARAM$finalmodel$optim$feature_fraction <- 0.7848
PARAM$finalmodel$optim$min_data_in_leaf <- 32013
