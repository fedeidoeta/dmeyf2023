...
PARAM$finalmodel$optim$num_iterations <- 1227
PARAM$finalmodel$optim$learning_rate <- 0.104046671356773
PARAM$finalmodel$optim$feature_fraction <- 0.435230473171832
PARAM$finalmodel$optim$min_data_in_leaf <- 10011
PARAM$finalmodel$optim$num_leaves <- 763
...
if (media_lag_delta) {
  ...
  cat("\nLag y delta lag de 1, 2 y 6  meses\n")
...
semillas  <- c(270029, 270001, semillas )
