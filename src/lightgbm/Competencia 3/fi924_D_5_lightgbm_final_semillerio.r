...
#fi9240_D_5:# Parametros Efficient Frontier
...
PARAM$finalmodel$optim$num_iterations <- 18 #17, 30, 20
PARAM$finalmodel$optim$learning_rate <- 1.0 #0.729, 1.0
PARAM$finalmodel$optim$feature_fraction <- 0.3  #0.1729, 0.8, 0.4
PARAM$finalmodel$optim$min_data_in_leaf <- 4871 #1729, 3000, 5000
PARAM$finalmodel$optim$num_leaves <- 64  #1729, 80, 40
