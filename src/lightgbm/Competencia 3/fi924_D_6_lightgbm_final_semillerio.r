...
#fi9240_D_6:# Parametros Efficient Frontier
# + PARAM$input$training <- c(201901, 201902, 201903, 201904, 201905,
#  202906, 201907, 201908, 201909, 201910, 201911, 201912, 202001,
#  202002, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105, 202106, 202107)
# + extra_trees = FALSE
# + early_stopping= 200
...
PARAM$finalmodel$optim$num_iterations <- 55 #17, 30, 20
PARAM$finalmodel$optim$learning_rate <- 0.8 #0.729, 1.0
PARAM$finalmodel$optim$feature_fraction <- 0.6  #0.1729, 0.8, 0.4
PARAM$finalmodel$optim$min_data_in_leaf <- 5000 #1729, 3000, 5000
PARAM$finalmodel$optim$num_leaves <- 26  #1729, 80, 40
