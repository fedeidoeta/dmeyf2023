...
PARAM <- list()
PARAM$experimento <- "final_base_zero_as_missing"
...
PARAM$finalmodel$optim$num_iterations <- 1910
PARAM$finalmodel$optim$learning_rate <- 0.02002379
PARAM$finalmodel$optim$feature_fraction <- 0.97749791
PARAM$finalmodel$optim$min_data_in_leaf <- 35063
PARAM$finalmodel$optim$num_leaves <- 389
