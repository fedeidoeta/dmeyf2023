...
PARAM <- list()
PARAM$experimento <- "202107_FE3004_m_m_r"
...
PARAM$finalmodel$optim$num_iterations <- 494
PARAM$finalmodel$optim$learning_rate <- 0.0415929308109175
PARAM$finalmodel$optim$feature_fraction <- 0.998897378094385
PARAM$finalmodel$optim$min_data_in_leaf <- 217
