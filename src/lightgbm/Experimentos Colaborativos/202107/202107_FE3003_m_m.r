...
PARAM <- list()
PARAM$experimento <- "202107_FE3003_m_m"
...
PARAM$finalmodel$optim$num_iterations <- 1167
PARAM$finalmodel$optim$learning_rate <- 0.114656088277229
PARAM$finalmodel$optim$feature_fraction <- 0.524797261113701
PARAM$finalmodel$optim$min_data_in_leaf <- 28507
PARAM$finalmodel$optim$num_leaves <- 681
