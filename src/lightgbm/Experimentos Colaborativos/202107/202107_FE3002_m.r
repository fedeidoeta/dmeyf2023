...
PARAM <- list()
PARAM$experimento <- "202107_FE3002_m"
...
PARAM$finalmodel$optim$num_iterations <- 208
PARAM$finalmodel$optim$learning_rate <- 0.164572848066875
PARAM$finalmodel$optim$feature_fraction <- 0.941346436471565
PARAM$finalmodel$optim$min_data_in_leaf <- 5963
PARAM$finalmodel$optim$num_leaves <- 767
