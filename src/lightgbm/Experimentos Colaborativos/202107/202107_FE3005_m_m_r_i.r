...
PARAM <- list()
PARAM$experimento <- "202107_FE3005_m_m_r_i"
...
PARAM$finalmodel$optim$num_iterations <- 1554
PARAM$finalmodel$optim$learning_rate <- 0.0781098758294653
PARAM$finalmodel$optim$feature_fraction <- 0.783758895442993
PARAM$finalmodel$optim$min_data_in_leaf <- 21670
PARAM$finalmodel$optim$num_leaves <- 1002
