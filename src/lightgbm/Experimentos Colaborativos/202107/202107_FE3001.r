...
PARAM <- list()
PARAM$experimento <- "202107_FE3001"
...
PARAM$finalmodel$optim$num_iterations <- 1926
PARAM$finalmodel$optim$learning_rate <- 0.029670982854983
PARAM$finalmodel$optim$feature_fraction <- 0.28986587350107
PARAM$finalmodel$optim$min_data_in_leaf <- 5878
