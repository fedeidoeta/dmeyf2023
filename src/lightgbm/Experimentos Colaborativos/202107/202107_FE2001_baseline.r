...
PARAM <- list()
PARAM$experimento <- "202107_FE2001_baseline"
...
PARAM$finalmodel$optim$num_iterations <- 530
PARAM$finalmodel$optim$learning_rate <- 0.150201744
PARAM$finalmodel$optim$feature_fraction <- 0.6684477344
PARAM$finalmodel$optim$min_data_in_leaf <- 48902
