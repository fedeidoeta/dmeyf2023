...
PARAM <- list()
PARAM$experimento <- "202107_FE2005_intra_mes"
...
PARAM$finalmodel$optim$num_iterations <- 359
PARAM$finalmodel$optim$learning_rate <- 0.0204560748071768
PARAM$finalmodel$optim$feature_fraction <- 0.974044436333914
PARAM$finalmodel$optim$min_data_in_leaf <- 100
PARAM$finalmodel$optim$num_leaves <- 42
