...
#                          201911, 201912, 202001, 202002, 202011, 
...
PARAM <- list()
PARAM$experimento <- "FE2006_meses_extra"
...
PARAM$finalmodel$optim$learning_rate <- 0.150201743998742
PARAM$finalmodel$optim$feature_fraction <- 0.668447734393479
