...
PARAM <- list()
PARAM$experimento <- "final_baseline_recargado_V1"

PARAM$input$dataset <- "./datasets/competencia_03_V2.csv.gz"

# meses donde se entrena el modelo
PARAM$input$training <- c(202009, 202008, 202007, 202006, 202005, 202004,
...
semillas  <- sample(primos)[ 21:cant_semillas ]   #tomo una muestra de numeros primos al azar
