# Script BO imputo con NA_ajustado para Experimento colaborativo
...
PARAM$experimento <- "BO_imputeNA_ajustado"
...
#En nuestro caso solo entran las variables de 202006 por el lag

cat("\nRegistros en 0 a NA\n")
zero_ratio <- list(
  list(mes = 202006, campo = 
         c("active_quarter", "catm_trx","catm_trx_other","ccajas_consultas",
           "ccajas_extracciones","ccajas_otras",
           ...
           "mtarjeta_master_consumo","mtarjeta_visa_consumo",
